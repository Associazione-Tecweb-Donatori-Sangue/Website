...
(9, 'ATDS Stadio Euganeo', 'images/sede_stadio_euganeo.jpg', 'Viale Nereo Rocco, 60, 35136 Padova PD', 'Punto donazioni situato nel cuore dello Stadio Euganeo, comodo per chi è appassionato di sport e desidera donare sangue in un ambiente moderno e accogliente.', 'https://maps.app.goo.gl/WJ6UjdbVFGkrou8J6', '+39 0123456789'),
(10, 'ATDS Tribunale', 'images/sede_tribunale.jpg', 'Via Niccolò Tommaseo, 55, 35131 Padova PD', 'Punto donazioni situato accanto al Tribunale di Padova, ideale per chi desidera donare sangue in un ambiente tranquillo e sicuro, senza differenze tra colpevoli o non.', 'https://maps.app.goo.gl/pyY1PEXFuoiGmMUu5', '+39 0123456789'),
(11, 'ATDS Ikea', 'images/sede_ikea.jpg', 'Via Sergio Fraccalanza, 1, 35129 Padova PD', 'Comodo punto donazioni situato in una delle principali catene di negozi di mobili e accessori per la casa, ideale per chi desidera donare sangue in un ambiente moderno e accogliente.', 'https://maps.app.goo.gl/BC6YpWbKVBmKFKoK9', '+39 0123456789');
